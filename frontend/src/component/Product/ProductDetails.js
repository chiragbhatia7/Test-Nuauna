...
const ProductDetails = ({ match }) => {
  ...
  return (
    ...
    //             <span>
    //               <button className="minus-btn" onClick={decreaseQuantity}>-</button>
    //               <input readOnly value="1" type="number"></input>
    //               <button className="plus-btn" onClick={increaseQuantity}>+</button>
    //             </span>
    //             <span>
